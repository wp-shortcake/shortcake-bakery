...
class Test_Iframe_Shortcode extends WP_UnitTestCase {
	...
	public function test_iframe_height_parameter() {
		...
		$post = get_post( $post_id );
		$this->assertContains( '<iframe src="//static.fusion.net/the-ultimate-choice/" width="100%" height="900" frameborder="0" scrolling="no" class="shortcake-bakery-responsive"></iframe>', apply_filters( 'the_content', $post->post_content ) );
	}
